...
- covers Faster R-CNNs to identify where object in an image, LSTM, YOLO for fast multiple object detection, RNN for generating sequences of data and Attention concept in Computer Vision.
