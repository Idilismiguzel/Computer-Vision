...
- [Landmark Detection and Tracking (SLAM)](https://github.com/Idilismiguzel/Landmark-Detection-and-Tracking) is the final project of the course and also the Nanodegree, requiring to implement a robust model for tracking object over time using probability, linear algebra and motion models. You need to use feature detection and keypoint descriptors to build a map of the environment with Simultaneous Locatization and Mapping (SLAM). Also this project has to be submitted and reviewed by Udacity team.
<p align="center">
